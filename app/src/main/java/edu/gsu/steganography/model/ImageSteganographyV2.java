...
public class ImageSteganographyV2 extends ImageSteganography {
    //Tag for Log
    private static String TAG = ImageSteganographyV2.class.getName();
    ...
    public ImageSteganographyV2() {
        this.encoded = false;
        this.decoded = false;
        this.secretKeyWrong = true;
    }

    public ImageSteganographyV2(String message, String secret_key, Bitmap image) {
    ...
    public ImageSteganographyV2(String secret_key, Bitmap image) {
        this.secret_key = convertKeyTo128bit(secret_key);
        this.image = image;
